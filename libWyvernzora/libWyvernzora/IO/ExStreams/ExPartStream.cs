/* =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
 * libWyvernzora.IO.ExPartStream.cs
 *      - Virtual partition of ExStream that acts as if a complete stream
 * --------------------------------------------------------------------------------
...
{
    /// <summary>
    /// A virtual partition of ExStream that acts as if it were a complete
    /// ExStream
    /// </summary>
